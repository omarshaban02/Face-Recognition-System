...
"}")
        ...
        self.wgt_img_input.setSizeIncrement(QtCore.QSize(1, 1))
        self.wgt_img_input.setBaseSize(QtCore.QSize(1, 1))
        self.wgt_img_input.setStyleSheet("background:beige;")
        self.wgt_img_input.setObjectName("wgt_img_input")
        self.verticalLayout_2.addWidget(self.wgt_img_input)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.checkBox_smiles = QtWidgets.QCheckBox(self.tab)
        self.checkBox_smiles.setObjectName("checkBox_smiles")
        self.horizontalLayout.addWidget(self.checkBox_smiles)
        self.checkBox_eyes = QtWidgets.QCheckBox(self.tab)
        self.checkBox_eyes.setObjectName("checkBox_eyes")
        self.horizontalLayout.addWidget(self.checkBox_eyes)
        ...
        self.scaleFactorSlider = QtWidgets.QSlider(self.tab)
        self.scaleFactorSlider.setMinimum(1)
        self.scaleFactorSlider.setMaximum(50)
        self.scaleFactorSlider.setOrientation(QtCore.Qt.Horizontal)
        self.scaleFactorSlider.setObjectName("scaleFactorSlider")
        self.horizontalLayout_2.addWidget(self.scaleFactorSlider)
        self.label_scale_factor_value = QtWidgets.QLabel(self.tab)
        self.label_scale_factor_value.setMinimumSize(QtCore.QSize(60, 0))
        self.label_scale_factor_value.setAlignment(QtCore.Qt.AlignCenter)
        self.label_scale_factor_value.setObjectName("label_scale_factor_value")
        self.horizontalLayout_2.addWidget(self.label_scale_factor_value)
        ...
        self.spinBox_min_neigbors = QtWidgets.QSpinBox(self.tab)
        self.spinBox_min_neigbors.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBox_min_neigbors.setObjectName("spinBox_min_neigbors")
        self.horizontalLayout_3.addWidget(self.spinBox_min_neigbors)
        ...
        self.gridLayout.addWidget(self.wgt_img_output, 0, 1, 1, 1)
        ...
        self.scaleFactorSlider.valueChanged['int'].connect(self.label_scale_factor_value.setNum) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_smiles.setText(_translate("MainWindow", "Smiles"))
        self.checkBox_eyes.setText(_translate("MainWindow", "Eyes"))
        self.label.setText(_translate("MainWindow", "Scale factor"))
        self.label_scale_factor_value.setText(_translate("MainWindow", "0"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Performance / ROC"))
